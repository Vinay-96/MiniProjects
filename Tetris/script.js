document.addEventListener("DOMContentLoaded", () => {
  ...
  // random selection and it's first number
  ...
  //move the teromino right, unless is at the edge or there is a blockage
  ...
  function rotate() {
    undraw();
    currentRotation++;
    // if current rotation is 4 make it to go back to xero
